    ...
    <div className="sticky">
      <div className="border rounded-lg">
          ...
          {[1, 1, 1, 1].map((item,index) => (
            ...
            <Avatar>
              ...
              <div className="space-y-2 py-2 px-5 border rounded-ss-2xl rounded-e-xl">
                <p>Ronit</p>
                <p className="text-violet-300">How are you?</p>
              </div>
            </div>:
        ...
        <div className="relative p-0">
          ...
          className="py-7 border-t outline-none focus:outline-none focus:ring-0 rounded-none border-b-0 border-x-0" value={message} onChange={handleMessageChange} />
